...
define('USER', 'u230541901_delivery');
define('PASS', 'Di030289@');
define('DBSA', 'u230541901_delivery');

// DEFINE SERVIDOR DE E-MAIL PARA RECEBER NOTIFICAÇÃO VIA E-MAIL ################
define('MAILUSER', 'suporte@gpuinfra.com'); // email: exemplo contato@pedido.top
define('MAILPASS', 'Di030289@'); // Senha do email
define('MAILPORT', '465'); // exemplo: 465
define('MAILHOST', 'mail.suporte.com');  // exemplo: mail.pedido.top 

// DEFINE IDENTIDADE DO SITE ################


// DEFINE A BASE DO SITE ####################
define('HOME', 'http://delivery.gpuinfra.com/'); // SEMPRE COM A BARRA NA FRENTE ---- ---- ---- ----
