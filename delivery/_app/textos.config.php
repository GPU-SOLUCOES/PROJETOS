...
$texto['telefoneAdministracaoTecnica'] = (!empty($getEmpresa[0]['tel_adm']) ? "55".$getEmpresa[0]['tel_adm'] : "41 99663-1610");
$texto['telefoneAdministracaoVendas']  = (!empty($getEmpresa[0]['tel_financeiro']) ? "55".$getEmpresa[0]['tel_financeiro'] : "41 99663-1610");

// E-MAIL DE SUPORTE E NOTIFICAÇÃO DO DONO DO SITE
$texto['emailSuporteSite']  = (!empty($getEmpresa[0]['email_suporte']) ? $getEmpresa[0]['email_suporte'] : "suporte@gpuinfra.com");

// HORÁRIOS PARA SUPORTE
$texto['horariosSuporteSite']  = (!empty($getEmpresa[0]['h_suporte']) ? $getEmpresa[0]['h_suporte'] : "09:00 as 18:00");
...
$texto['valorPlanoUm']  = (!empty($getEmpresa[0]['v_plano_um']) ? $getEmpresa[0]['v_plano_um'] : "60"); 
$texto['DiasPlanoUm']   = (!empty($getEmpresa[0]['dias_plano_um']) ? $getEmpresa[0]['dias_plano_um'] : "30"); // valor em dias
//plano 2
$texto['nomePlanoDois']   = (!empty($getEmpresa[0]['nome_plano_dois']) ? $getEmpresa[0]['nome_plano_dois'] : "");
$texto['valorPlanoDois']  = (!empty($getEmpresa[0]['v_plano_dois']) ? $getEmpresa[0]['v_plano_dois'] : "150"); // Sempre valor inteiro
$texto['DiasPlanoDois']   = (!empty($getEmpresa[0]['dias_plano_dois']) ? $getEmpresa[0]['dias_plano_dois'] : "90"); // valor em dias
//plano 3
$texto['nomePlanoTres']   = (!empty($getEmpresa[0]['nome_plano_tres']) ? $getEmpresa[0]['nome_plano_tres'] : "");
$texto['valorPlanoTres']  = (!empty($getEmpresa[0]['v_plano_tres']) ? $getEmpresa[0]['v_plano_tres'] : "500"); // Sempre valor inteiro
$texto['DiasPlanoTres']   = (!empty($getEmpresa[0]['dias_plano_tres']) ? $getEmpresa[0]['dias_plano_tres'] : "365"); // valor em dias

// DIAS PARA TESTAR O SISTEMA
$texto['DiasDeTeste']   = (!empty($getEmpresa[0]['dias_testes']) ? $getEmpresa[0]['dias_testes'] : "7"); // valor em dias - minimo tem que ser 1
